                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ZoomTapAnimation(
                            onTap: () {
                              context.push(AppRouter.orderHistoryDitails,
                                  extra: data);
                            },
                            child: Container(
                                ...
                                children: [
                                  ...
                                  Wrap(
                                    ...
                                    children: List.generate(
                                      ...
                                      (generator) => Container(
                                        ...
                                        child: Image.network(
                                          data.products?[generator].images
                                                  ?.firstOrNull?.image ??
                                              "",
                                          fit: BoxFit.cover,
                                        ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Translator(
                                        uz: "${Utils.cashFormat("${data.totalAmount ?? 0}")} ${"sum".tr()}",
                                        ru: "${Utils.cashFormat("${data.totalAmount ?? 0}")} ${"sum".tr()}",
                                        crl:
                                            "${Utils.cashFormat("${data.totalAmount ?? 0}")} ${"sum".tr()}",
                                        style:
                                            AppStyle.w700s18h28DarkBluePrimary,
                                        maxLen: 4,
