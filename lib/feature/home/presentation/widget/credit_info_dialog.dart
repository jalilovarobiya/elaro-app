            ...
            child: Column(
              children: [
                Row(
                  children: [
                    Translator(
                      uz: "Muddatli to'lovga",
                      ru: "В рассрочку",
                      crl: "Муддатли тўловга",
                ...
                Translator(
                  ...
                  crl:
                      "Муддатли тўлов нархи 24 ойга Ахиом насия томонидан кўрсатилган",
                  style: AppStyle.w400s13h18DarkBlue300,
                  maxLen: 4,
                ),
                const SizedBox(height: 12),
                  ...
                  children: [
                    ListTile(
                      ...
                      title: Translator(
                        ...
                        crl:
                            "Сизга қулай бўлган исталган дўконга ташриф буюринг.\nПаспорт олингандан кейин",
                        maxLen: 3,
                        style: AppStyle.w400s13h18DarkBlue300,
                      ),
                    ),
                    ...
                    ListTile(
                      ...
                      title: Translator(
                        ...
                        crl:
                            "Дўкон ходимларига мурожаат қилинг. Сизга муддатли тўлов шартлари ҳақида маълумот берилади",
                        maxLen: 3,
                        style: AppStyle.w400s13h18DarkBlue300,
                      ),
                    ),
                    ListTile(
                      ...
                      title: Translator(
                        ...
                        crl:
                            "Агар сизни муддатли тўлов шартлари қаноатлантирса, шартномани расмийлаштиринг ва харидингизни уйингизга олиб кетинг.",
                        maxLen: 3,
                        style: AppStyle.w400s13h18DarkBlue300,
                      ),
                    ),
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      title: Translator(
                        ...
                        crl:
                            'Буюртма расмийлаштириш босқичида тўлов усули "Муддати тўлов"ни танланг.',
                        maxLen: 3,
                        style: AppStyle.w400s13h18DarkBlue300,
                      ),
                    ),
                    ListTile(
                      ...
                      title: Translator(
                        ...
                        crl:
                            "Керакли маълумотларни тўлдиринг ва оператор қўнғироғини кутинг.",
                        maxLen: 3,
                        style: AppStyle.w400s13h18DarkBlue300,
                      ),
                    ),
